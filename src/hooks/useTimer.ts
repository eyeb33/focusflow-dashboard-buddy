...
export const useTimer = (settings: TimerSettings) => {
  ...
  }, [settings, timerMode, isRunning, currentSessionIndex, getTotalTimeForMode, saveTimerState]);
  ...
  }, [timerMode, settings, completedSessions, currentSessionIndex, setCompletedSessions, setTimerMode]);
  ...
  }, [timerMode, settings, currentSessionIndex, saveTimerState]);
